      ...
      <div className="bg-[#111] border border-[#333] rounded-2xl w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl">
        <div className="p-6 border-b border-[#333] flex justify-between items-center">
          <div className="flex items-center gap-3">
            {step === 'machine' && (
              <button onClick={handleBack} className="p-2 hover:bg-[#222] rounded-lg text-gray-400 hover:text-white transition-colors">
                <FiArrowLeft size={20} />
              </button>
            )}
            <div>
              ...
              {services.map((service) => {
                ...
                return (
                  <button
                    ...
                    className={`p-6 rounded-xl border transition-all text-left group ${service.isAvailable ? '' : 'opacity-50 cursor-not-allowed'} ${
                  ...
                  >
                    ...
                    <h3 className={`font-semibold mb-2 ${selectedService === service.type ? 'text-white' : 'text-gray-200'}`}>
                      {service.title}
                    </h3>
